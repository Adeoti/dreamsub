            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 col-12">
                    <div class="hero-image wow fadeInRight" data-wow-delay=".4s">
                        <img class="main-image" src="{{ asset("assets/images/after-hero-left.png") }}"  style="border-radius: 20px; transform:rotate(15deg) scale(.8); border:4px solid lightgray;" alt="#">
                    </div>
                </div>
            </div>
        </div>
